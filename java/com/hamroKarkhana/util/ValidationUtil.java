...
public class ValidationUtil {
 ...
 // 12. Validate if name contains only letters and spaces
    ...
    // 11. Validate if username is alphanumeric and starts with a letter
    public static boolean isValidUsername(String username) {
        return username != null && username.matches("^[a-zA-Z][a-zA-Z0-9]{5,}$");
    }

    // 12. Validate if address length is within a reasonable limit (max 50 characters)
    public static boolean isValidAddress(String address) {
        return address != null && address.length() <= 50;
    }
}
