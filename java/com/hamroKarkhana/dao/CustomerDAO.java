...
public class CustomerDAO {
    ...
    public boolean updateCustomer(CustomerModel customer) {
        ...
        try (Connection conn = DbConfig.getDbConnection();
            ...
            stmt.setString(6, customer.getProfilePicture()); // If profile picture is null, it will be updated to null
            ...
            e.printStackTrace();  // This will help you pinpoint the issue
            return false;
